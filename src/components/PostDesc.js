  ...
  return (
    <>
      <div className="title-single-post">
        <a className="text-link" href="#section">
          Lifestyle
        </a>
        ...
        <div className="post-content">
          <div className="post-social">
            ...
            <ul className="share-post">
              <li>
                <a href="#section" className="facebook">
                  <i className="fa fa-facebook"></i>
                </a>
              </li>
              <li>
                <a href="#section" className="twitter">
                  <i className="fa fa-twitter"></i>
                </a>
              </li>
              <li>
                <a href="#section" className="pinterest">
          ...
          <div className="post-content-text">
            <p>
              ...
              ligula <a href="#section">sollicitudin laoreet viverra</a>, tortor
            ...
            <p>
              ...
              <a href="#section">elementum hendrerit </a> tortor. Sed semper
            ...
            <p>
              ...
              dui, eu <a href="#section">pulvinar nunc sapien</a> ornare nisl.
            ...
            <p>
              ...
              <a href="#section">adipiscing varius </a>, adipiscing in, lacinia
            ...
            <div className="share-tags-box">
              <ul className="tags">
                ...
                <li>
                  <a href="#section">adventure</a>
                </li>
                <li>
                  <a href="#section">lifestyle</a>
                </li>
              </ul>
              <ul className="shares-likes">
                <li>
                  <a href="#section" className="likes">
          ...
          <div className="row">
            <div className="col-lg-4 col-md-4">
              <div className="news-post standard-post text-left">
                ...
                <ul className="post-tags">
                  <li>
                    by <a href="#section">Stan Enemy</a>
                  </li>
                  <li>3 days ago</li>
                </ul>
              </div>
